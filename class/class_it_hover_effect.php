 ...
 */
if ( class_exists( 'WPBakeryShortCodesContainer' ) && ! class_exists( 'WPBakeryShortCode_ith_hover_effect' ) ) {
	class WPBakeryShortCode_ith_hover_effect extends WPBakeryShortCodesContainer {
	}
